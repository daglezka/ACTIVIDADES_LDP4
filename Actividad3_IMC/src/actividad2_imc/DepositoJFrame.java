...
import actividad2_imc.Actividad2_IMC;
...
public class DepositoJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("BancoMexicano | Depósito");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jbtnDepositar, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(30, 30, 30)
   ...
   try {
        ...
        Actividad2_IMC.saldoGlobal += monto; 
        ...
        if (resp == JOptionPane.YES_OPTION) {
            txtMonto.setText(""); // Limpia para un nuevo depósito
        } else {
            this.dispose(); // Regresa al menú principal 
        }
        
    } catch (NumberFormatException e) {
        // Validación en caso de que el campo esté vacío o contenga letras 
